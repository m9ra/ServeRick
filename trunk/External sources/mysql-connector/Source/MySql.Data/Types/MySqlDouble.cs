...
namespace MySql.Data.Types
{
    ...
    internal struct MySqlDouble : IMySqlValue
    {
        ...
        private static readonly object _L_toString = new object();
        ...
        void IMySqlValue.WriteValue(MySqlPacket packet, bool binary, object val, int length)
        {
            ...
            else
            {
                ...
                lock (_L_toString)
                {
                    //WORKAROUND BECAUSE OF MONO BUG
                    stringed = v.ToString("R", CultureInfo.InvariantCulture);
                }
                packet.WriteStringNoNull(stringed);
            }
